        ...
        <div className="bg-gray-500 bg-opacity-75 absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center">
            <div className="w-[70%] h-[600px] bg-color-3 bg-opacity-25 flex justify-between">
                <div className="left">
                        ...
                        <div>
                            <span>{Number(coinDetail?.market_data?.price_change_percentage_24h).toFixed(2)}</span>
                        </div>
                        <div>
                            <h3>Market cap</h3>
                            ...
                            }).format(coinDetail?.market_data?.market_cap[currency])}</span>
                        </div>
                        <div>
                            ...
                            <span>{new Intl.NumberFormat("en-IN",{
                                ...
                                currency:currency,
                                notation:"compact"
                            }).format(coinDetail?.market_data?.fully_diluted_valuation[currency])}</span>
                        </div>
                        <div>
                            <h3>total volume</h3>
                            <span>{new Intl.NumberFormat("en-IN",{
                            ...
                            }).format(coinDetail?.market_data?.total_volume[currency])}</span>
                        </div>
                        <div>
                            <h3>low 24h</h3>
                            <span>{new Intl.NumberFormat("en-IN",{
                                ...
                                currency:currency,
                                maximumSignificiantDigits:5,
                            }).format(coinDetail?.market_data?.low_24h[currency])}</span>
                        </div>
                        <div>
                            <h3>high 24h</h3>
                            <span>{new Intl.NumberFormat("en-IN",{
                                ...
                                currency:currency,
                                maximumSignificiantDigits:0,
                            }).format(coinDetail?.market_data?.high_24h[currency])}</span>
                        </div>
                        <div>
                            <h3>max supply</h3>
                            <span>{new Intl.NumberFormat("en-IN",{
                                ...
                                currency:currency,
                                maximumSignificiantDigits:0,
                            }).format(coinDetail?.market_data?.max_supply)}</span>
                        </div>
                        <div>
                            ...
                            <span>{new Intl.NumberFormat("en-IN",{
                                ...
                                currency:currency,
                                maximumSignificiantDigits:0,
                            }).format(coinDetail?.market_data?.circulatiog_supply)}</span>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="p-2 bg-green-300">
                                <span>{Number(coinDetail?.sentiment_votes_up_percentage).toFixed(2)}</span>
                            </div>
                            <div className="p-2 bg-red-300">
                                <span>{Number(coinDetail?.sentiment_votes_down_percentage).toFixed(2)}</span>
                            </div>
                        </div>
                </div>
                <div className="right">
                    <ul>
                        <Chart />
                        <div>
                            market cap rank : {coinDetail?.market_cap_rank}
                        </div>
                        <div>
                            coingecko rank: {coinDetail?.coingecko_rank}</div>
